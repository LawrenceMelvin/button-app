        ...
        return (
            <div>
                <form className="formDetails" style={{display:this.state.disp}}>
                    Enter your age: <input type="number" placeholder="Current Age" value={this.state.age} onChange={this.handelChange}/>
                    <h1>{days}</h1>
                    <input type="reset" name="Reset" value="Reset" onClick={this.checkReset}/>
                </form>                
            </div>
        )
    }
