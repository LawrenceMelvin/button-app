        ...
        return (
            <div>
                <form className='formDetails'>
                    Weigth:<input type='number' name='weigth' placeholder='Enter your weigth in Kgs' value={this.state.weight} onChange={this.handeleWeigthChange} /><br/>
                    Heigth:<input type='number' name='heigth' placeholder='Enter your Heigth in cms' value={this.state.height} onChange={this.handleHeigthChange}/><br/>
                    <Result bmi={bmi} label={results.label} alertClass={results.alertClass}/>
                </form>
            </div>
        )
    }
